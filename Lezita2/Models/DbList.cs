    ...
    public static class DbList
    {
        ...
        static DbList()
        {
            ...
            categories = new List<Category>
            {
                ...
                new Category(){Name="KURABİYELER",Image="/images/kurabiyeler.jpg"  },
                new Category(){Name="KEKLER",Image="/images/kekler.jpg"  },
                new Category(){Name="Kahveler",Image="/images/kahveler.jpg"  },
            };
        }
    }
}
